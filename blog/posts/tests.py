...
class PostViewsTestCase(TestCase):
    ...
    def test_post_page_handles_disabled_comments(self):
        response = self.client.get('/blog/2012/05/2_Building_A_Blog_Part_2/')
    ...
    def test_post_comment_handles_valid_data(self):
        ...
        response = self.client.post('/blog/2012/05/3_Building_A_Blog_Part_3/',
                                    {'name': 'Fred',
                                     'text': 'This is a comment.'})
        self.assertEqual(response.status_code, 302)
        self.assertEqual(response['Location'],
                    'http://testserver/blog/2012/05/3_Building_A_Blog_Part_3/')
    ...
    def test_post_comment_handles_invalid_data(self):
        ...
        response = self.client.post('/blog/2012/5/4_Not_A_Post/')
        self.assertEqual(response.status_code, 404)
